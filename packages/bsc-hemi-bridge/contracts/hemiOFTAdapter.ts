...
export const getHemiOftAdapterAddress = function (chainId: number): Address {
  ...
  if (!address) {
    throw new Error(
      `HemiOFTAdapter contract not available for chain ${chainId}`,
    );
  }
  return address;
};
